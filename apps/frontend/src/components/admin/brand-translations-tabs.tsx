...
export interface BrandTranslationsTabsRef {
  resetChanges: () => void;
  validateAll: () => { isValid: boolean; errors: Record<string, string[]> };
  getTranslationData: () => Record<string, { name: string; description: string }>;
}

export const BrandTranslationsTabs = forwardRef<BrandTranslationsTabsRef, BrandTranslationsTabsProps>(({
  brandId,
  defaultName = '',
  defaultDescription = '',
  creationMode = false,
...
BrandTranslationsTabs.displayName = 'BrandTranslationsTabs';
